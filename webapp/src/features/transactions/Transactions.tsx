    ...
    <>
      ...
      <div className="mb-6 md:mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-text-quaternary">Gestiona tus ingresos y gastos</p>
        </div>
        <Button
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="glass-card rounded-lg p-4">
              ...
              <h4 className="text-sm font-medium text-foreground mb-1">Búsqueda</h4>
              <p className="text-xs text-text-tertiary">Búsqueda en tiempo real</p>
            </div>
            <div className="glass-card rounded-lg p-4">
              <Filter className="h-8 w-8 text-sp-purple-400 mx-auto mb-2" />
              <h4 className="text-sm font-medium text-foreground mb-1">Filtros</h4>
              <p className="text-xs text-text-tertiary">Por fecha, cuenta, categoría</p>
            </div>
            <div className="glass-card rounded-lg p-4">
              <div className="text-2xl mx-auto mb-2">📊</div>
              <h4 className="text-sm font-medium text-foreground mb-1">Historial</h4>
              <p className="text-xs text-text-tertiary">Ordenado por fecha</p>
            </div>
          </div>
