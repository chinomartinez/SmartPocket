...
const commonActivityFields = {
  ...
  currencyCode: z.string().length(3, "Usá un código de 3 letras").transform((value) => value.toUpperCase()),
};
...
export type CreditCardPurchaseActivityFormValues = z.infer<
  typeof creditCardPurchaseActivitySchema
>;
