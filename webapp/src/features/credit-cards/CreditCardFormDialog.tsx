        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ej: Visa Signature" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                    ...
                    <FormControl>
                      <div className="flex gap-2">
                        <input
                          ...
                          className="h-9 w-12 cursor-pointer rounded-md border border-border-subtle bg-transparent p-1"
                        />
            ...
            <div className="space-y-4 rounded-xl border border-border-subtle bg-surface-container-low/50 p-4">
              <div>
                <h3 className="text-sm font-semibold text-foreground">Fechas habituales</h3>
                <p className="mt-1 text-xs text-text-quaternary">
                  Pueden cruzar el fin de mes, por ejemplo del 26 al 2.
                </p>
              </div>
              <DayRangeFields
                control={form.control}
                name="statementClosingRange"
                label="Cierre habitual"
              />
              <DayRangeFields
                control={form.control}
                name="paymentDueRange"
  ...
  return (
    <div className="grid grid-cols-[1fr_auto_1fr] items-end gap-2">
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className="text-xs text-text-quaternary">{label}: desde</FormLabel>
            <FormControl>
              <Input
                type="number"
                min="1"
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className="text-xs text-text-quaternary">hasta</FormLabel>
            <FormControl>
              <Input
                type="number"
                min="1"
