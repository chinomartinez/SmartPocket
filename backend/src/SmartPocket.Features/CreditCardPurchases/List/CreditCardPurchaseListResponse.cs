...
{
    public class CreditCardPurchaseListResponse
    {
        public IEnumerable<CreditCardInstallmentPurchaseListItemDTO> Installments { get; set; } = [];

        public IEnumerable<CreditCardSubscriptionListItemDTO> Subscriptions { get; set; } = [];
    }
