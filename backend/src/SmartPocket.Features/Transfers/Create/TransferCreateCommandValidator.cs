...
{
    public class TransferCreateCommandValidator : AbstractValidator<TransferCreateCommand>
    {
        public TransferCreateCommandValidator(ISmartPocketContext smartPocketContext)
        {
            RuleFor(x => x.Amount)
                .GreaterThan(0)
