        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-4">
          <Card className="glass-card max-w-md w-full">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl text-foreground">Algo salió mal</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              {import.meta.env.DEV && this.state.error && (
                <div className="rounded-lg bg-glass-base p-4 border border-border-subtle">
                  <p className="text-xs text-red-400 break-all">{this.state.error.message}</p>
                </div>
              )}

              <div className="flex gap-3 justify-center">
                <Button onClick={this.handleReset} className="bg-sp-blue-600 hover:bg-sp-blue-700">
                ...
                <Button
                  ...
                  variant="outline"
                  className="border-border text-muted-foreground hover:bg-hover-muted"
                >
                  Ir al inicio
                </Button>
              </div>
